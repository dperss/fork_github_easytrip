...
class PersonList extends Component {
    ...
    searchData = (currentPage) => {
        currentPage -= 1;
        axios.get("http://localhost:8080/api/test/point_of_interests/search/name/{searchText}?="+this.state.search+"?page="+currentPage+"&size="+this.state.personsPerPage)
            .then(response => response.data)
            .then((data) => {
                this.setState({
                    persons: data.content,
    ...
    render() {
        ...
        return (
            <div>
                ...
                <Card className={"border border-grey bg-grey text-black"}>
                    <Card.Header>
                        ...
                        <div style={{"float":"right"}}>
                            <InputGroup size="sm">
                                <FormControl placeholder="Search" name="search" value={search}
                                             className={"info-border bg-grey text-black"}
                    ...
                    <Card.Body>
                        <Table bordered hover striped variant="grey">
                            <thead>
                            <tr>
                                <th>Nome</th>
                                <th>Localização</th>
                        ...
                        <Card.Footer>
                            ...
                            <div style={{"float":"right"}}>
                                <InputGroup size="sm">
                                    ...
                                    <FormControl className={"page-num bg-grey"} name="currentPage" value={currentPage}
