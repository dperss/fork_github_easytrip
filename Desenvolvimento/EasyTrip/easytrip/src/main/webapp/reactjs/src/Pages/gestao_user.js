...
export default class gestao_user extends React.Component{
                ...
                <Container style = {{marginTop: "100px"}}>
                    <Table responsive >
                        ...
                        <tr>
                            ...
                            <th>Email</th>
                            <th>Password</th>
                            <Button  variant = "outline-dark" >Congelar</Button>
                            <Button  variant = "outline-dark" style = {{marginLeft: "5px"}}>Eliminar</Button>
                            <Button  variant = "outline-dark" style = {{marginLeft: "5px"}}>Ver apenas</Button>
                        </tr>
                        </thead>
                        <tbody>
