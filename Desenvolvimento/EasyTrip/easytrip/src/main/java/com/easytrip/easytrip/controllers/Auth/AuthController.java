package com.easytrip.easytrip.controllers.Auth;
...
import com.easytrip.easytrip.payload.request.LoginRequest;
import com.easytrip.easytrip.payload.request.SignupRequest;
import com.easytrip.easytrip.payload.response.JwtResponse;
...
import com.easytrip.easytrip.security.jwt.JwtUtils;
		...
		if (strRoles == null) {
			...
			strRoles.forEach(role -> {
				...
				case "admin":
					...
					break;
				case "user_blocked":
					Role modRole = roleRepository.findByName(ERole.ROLE_USER_BLOCKED)
							.orElseThrow(() -> new RuntimeException("Error: User blocker is not found."));
					roles.add(modRole);
